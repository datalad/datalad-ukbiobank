            ...
            for cmd in 'manpage',: #'examples':
                os.system(
                    '{} build_{} --cmdsuite {} --manpath {} --rstpath {}'.format(
                        setup_py_path,
                        cmd,
                        'datalad_ukbiobank:command_suite',
...
project = u'DataLad UK Biobank'
copyright = u'2019-{}, DataLad team'.format(datetime.datetime.now().year)
author = u'DataLad team'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
version = datalad_ukbiobank.__version__
release = version
